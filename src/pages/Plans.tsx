...
const plans: Plan[] = [
  {
    id: 'free',
    name: 'Gratuito',
    description: 'Ideal para quem quer começar a se organizar sem compromisso',
    monthlyPrice: 0,
    yearlyPrice: 0,
    yearlyDiscount: 0,
    ...
    features: [
      ...
      'Dashboard básico (saldo, receitas, despesas)',
  ...
  },
  {
    id: 'paid',
    name: 'Premium',
    description: 'Ideal para quem quer controle real do dinheiro no dia a dia',
    monthlyPrice: 19.90,
  ...
  },
  {
    id: 'couple',
    name: 'Conta Casal',
    description: 'Ideal para casais que querem organizar a vida financeira juntos',
    monthlyPrice: 29.90,
